...
class TrainingSession(Base, TimestampMixin):
    ...
    status: Mapped[TrainingSessionStatus] = mapped_column(Enum(TrainingSessionStatus, name="training_session_status", values_callable=enum_values))
    mode: Mapped[TrainingSessionMode] = mapped_column(Enum(TrainingSessionMode, name="training_session_mode", values_callable=enum_values), default=TrainingSessionMode.personal_review)
